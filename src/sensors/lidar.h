...
//     // resoultion: the magnitude of the ray's step, used for ray casting, the smaller the more accurate but
//     // the more expensive

//     Ray(Vect3 setOrigin, double horizontalAngle, double verticalAngle, double setresoultion)
